...
def speed_of_motor():
    ...
    time_array=np.append(time_array,time_now)
...
plt.title("speed transients PID controller")
plt.xlabel("time")
...
plt.title("error variation PID controller")
plt.xlabel("time")
...
plt.plot(time_array,PID_array,"bo")
plt.plot(time_array, PID_array,"b")
plt.plot(time_array,error_array,"ro")
plt.plot(time_array,error_array,"r")
plt.plot(time_array,np.zeros(size_of_array))
...
plt.title("PID error,error variation vs throttle control PID controller")
plt.xlabel("time")
plt.ylabel("speed and pwm")
plt.grid(True)
plt.show()
...
plt.title("comparison correction and actual PID controller")
plt.xlabel("time")
plt.ylabel("pwm correction ")
plt.grid(True)
plt.show()
...
plt.plot(time_array,speed_array,"k")
plt.plot(time_array,set_point_array,"g")
plt.plot(time_array,throttle_control_array,"b*")
plt.plot(time_array,throttle_control_array,"b")
...
plt.plot(time_array,np.zeros(size_of_array))
plt.title("PID variation & PID error controller")
plt.xlabel("time")
plt.ylabel("erro magnitude")
plt.grid(True)
